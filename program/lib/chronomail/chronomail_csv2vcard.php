...
class chronomail_csv2vcard
{
    ...
    public function import($csv)
    {
        ...
        $charset   = chronomail_charset::detect($head, RCUBE_CHARSET);
        $csv       = chronomail_charset::convert($csv, $charset);
     ...
     * Export vCards
     *
     * @return array chronomail_vcard List of vcards
     */
    ...
    protected function parse_line($line)
    {
        ...
        $fields = chronomail_utils::explode_quoted_string(',', $line);
    ...
    protected function csv_to_vcard($data)
    {
        ...
        // Convert address(es) to chronomail_vcard data
