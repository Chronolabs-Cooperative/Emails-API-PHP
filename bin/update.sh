...
// get arguments
$opts = chronomail_utils::get_opt(array('v' => 'version', 'y' => 'accept:bool'));
...
if ($RCI->configured) {
    ...
    if ($RCI->config['db_dsnw']) {
        ...
        $success = chronomail_utils::db_update(INSTALL_PATH . 'SQL', 'chronomail', $opts['version'],
            array('errors' => true));
    }
    ...
    if ($success) {
        echo "This instance of chronomail is up-to-date.\n";
        echo "Have fun!\n";
    }
}
else {
    echo "This instance of chronomail is not yet configured!\n";
    echo "Open http://url-to-chronomail/installer/ in your browser and follow the instuctions.\n";
}
