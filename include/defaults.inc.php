...
//       e.g. 'mysql://chronomail:@localhost/chronomailmail?verify_server_cert=false'
...
// For example chronomail uses max_allowed_packet value (in bytes)
...
// for shared namespaces in this case. https://github.com/chronomail/chronomailmail/issues/2474
...
// This is used to relate IMAP session with chronomail user sessions
...
// extensions (RFC7162). See synchronize() in program/lib/chronomail/chronomail_imap_cache.php
...
// - URL relative to the document root of this chronomail installation
...
// automatically create a new chronomail user when log-in the first time.
...
$config['log_dir'] = '/var/log/chronomail';
...
// e.g. when you're running chronomail behind a https proxy
...
// Session name. Default: 'chronomail_sessid'
$config['session_name'] = null;

// Session authentication cookie name. Default: 'chronomail_sessauth'
...
$config['product_name'] = 'Chronomail';

// Add this user-agent to message headers when sending
$config['useragent'] = 'Chronomail/'.RCUBE_VERSION;

// try to load host-specific configuration
// see https://github.com/chronomail/chronomailmail/wiki/Configuration:-Multi-Domain-Setup
// for more details
$config['include_host_config'] = false;

// path to a text file which will be added to each sent message
// paths are relative to the chronomail root folder
...
// If this option is true, chronomail will use user's identity as envelope sender for MDN responses.
...
//    RewriteRule ^/chronomailmail/[a-zA-Z0-9]{16}/(.*) /chronomailmail/$1 [PT]
//    Alias /chronomailmail /var/www/chronomailmail/
...
// connect to http://spell.chronomail.net which is a hosted service provided by chronomail.
...
$config['skins_allowed'] = array('classic','elastic','emailer','larry');
