 ...
 * @subpackage View
 */
class chronomail_html_page extends chronomail_output_html
{
    ...
    public function write($contents = '')
    {
        ...
        if ($embed_css = $this->get_skin_file($embed_css, $path, null, true)) {
            ...
            $this->add_header(html::tag('style', array('type' => 'text/css'),
                ".chronomail-inline-message { font-family: sans-serif; border:2px solid #ffdf0e;"
                                        . "background:#fef893; padding:0.6em 1em; margin-bottom:0.6em }\n" .
                ".chronomail-inline-buttons { margin-bottom:0 }"
            ));
        }
    ...
    public function register_inline_warning($text, $button_label = null, $button_url = null)
    {
        ...
        if ($button_label) {
            ...
            $button  = html::tag('button', array('onclick' => $onclick), chronomail::Q($button_label));
            $text   .= html::p(array('class' => 'chronomail-inline-buttons'), $button);
        }

        $this->inline_warning = html::div(array('class' => 'chronomail-inline-message chronomail-inline-warning'), $text);
    }
}
