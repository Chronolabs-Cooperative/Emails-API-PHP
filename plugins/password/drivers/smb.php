 ...
 *
 * Based on chpasswd chronomailmail password driver by
...
class chronomail_smb_password
{

    public function save($currpass, $newpass, $username)
    {
        $host     = chronomail::get_instance()->config->get('password_smb_host','localhost');
        $bin      = chronomail::get_instance()->config->get('password_smb_cmd','/usr/bin/smbpasswd');
