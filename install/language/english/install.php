...
define('API_ZONES_LABEL', 'DNS Zones REST Services API (see: <a href="https://github.com/Chronolabs-Cooperative/Zones-API-PHP" target="_blank">github.com...</a>)');
define('API_ZONES_HELP', 'Physical URL to the REST API as installed from github.com');
define('API_ZONES_USER_LABEL', 'DNS Zonex REST API Username (see: <a href="https://github.com/Chronolabs-Cooperative/Zones-API-PHP" target="_blank">github.com...</a>)');
define('API_ZONES_USER_HELP', 'Physical username for the zoning dns rest service');
define('API_ZONES_PASS_LABEL', 'DNS Zone REST API Password (see: <a href="https://github.com/Chronolabs-Cooperative/Zones-API-PHP" target="_blank">github.com...</a>)');
define('API_ZONES_PASS_HELP', 'Physical password for the zoning dns rest service');
...
define('API_IMAP_HOSTNAME_LABEL', 'Hostname of this email services IMAP Services');
define('API_IMAP_HOSTNAME_HELP', 'This is the full hostname netbios path for your IMAP Service!');
define('API_POP3_HOSTNAME_LABEL', 'Hostname of this email services POP3 Services');
define('API_POP3_HOSTNAME_HELP', 'This is the full hostname netbios path for your POP3 Service!');
define('API_SMTP_HOSTNAME_LABEL', 'Hostname of this email services IMAP Services');
define('API_SMTP_HOSTNAME_HELP', 'This is the full hostname netbios path for your SMTP Service!');
define('API_WEB_HOSTNAME_LABEL', 'Hostname of this email services IMAP Services');
define('API_WEB_HOSTNAME_HELP', 'This is the full hostname netbios path for your Web Mail Service!');
...
define('API_EMAIL_PGPKEYS_LABEL', 'Drop Email Inbox for External PGP Keys');
define('API_EMAIL_PGPKEYS_HELP', 'This is an email address for recieving PGP Keys');
define('API_IMAP_PGPKEYS_LABEL', 'IMAP Service for Drop Email Inbox');
define('API_IMAP_PGPKEYS_HELP', 'Netbios Hostname for IMAP Service for Drop Inbox');
define('API_PORT_PGPKEYS_LABEL', 'IMAP Port Service for Drop Email Inbox');
define('API_PORT_PGPKEYS_HELP', 'IMAP Port for IMAP Service for Drop Inbox');
define('API_USER_PGPKEYS_LABEL', 'Username for Email Inbox Drop Box');
define('API_USER_PGPKEYS_HELP', 'Login Username for email inbox');
define('API_PASS_PGPKEYS_LABEL', 'Password for Email Inbox Drop Box');
define('API_PASS_PGPKEYS_HELP', 'Login Password for email inbox');
define('API_MINBITS_PGPKEYS_LABEL', 'Minimum Bits to randomly select from generating PGP Keys (min = 1024)');
define('API_MINBITS_PGPKEYS_HELP', 'Minimum Bits for PGP Keys (min = 1024)');
define('API_MAXBITS_PGPKEYS_LABEL', 'Maximum Bits to randomly select from generating PGP Keys (max = 4096)');
define('API_MAXBITS_PGPKEYS_HELP', 'Maximum Bits for PGP Keys (max = 4096)');
define('API_MAXIMUM_INBOXMBS_LABEL', 'Maximum inbox Mb\'s');
define('API_MAXIMUM_INBOXMBS_HELP', 'This is an maximum number of mb\'s for the inbox');
define('API_MINIMUM_INBOXMBS_LABEL', 'Minimum inbox Mb\'s');
define('API_MINIMUM_INBOXMBS_HELP', 'This is the minumum number of mb\'s for the inbox');
define('API_INTIALISE_INBOXMBS_LABEL', 'Intialisation size of inbox Mb\'s');
define('API_INTIALISE_INBOXMBS_HELP', 'Size of an email address when created intialisation size of inbox');
define('API_OFFLINE_INBOXMBS_LABEL', 'Offline Size of Email Inbox Mb\'s');
define('API_OFFLINE_INBOXMBS_HELP', 'offline size of email inbox');
define('API_DEPRECIATED_INBOXMBS_LABEL', 'Depreciated size of email inbox Mb\'s');
define('API_DEPRECIATED_INBOXMBS_HELP', 'Depreciated size of email inbox');
...
// Emails REST API
define('API_CONFIG_IMAPPOP', 'Configuration Settings for IMAP + POP3');
define('API_CONFIG_SMTP', 'Configuration Settings for SMTP');
define('PATHS_IMAPPOP', 'Config IMAP + POP3');
define('PATHS_IMAPPOP_TITLE', 'Config IMAP + POP3');
define('PATHS_SMTP', 'Config SMTP');
define('PATHS_SMTP_TITLE', 'Config SMTP');
define('PATHS_OPENPGP', 'Config OpenPGP');
define('PATHS_OPENPGP_TITLE', 'Config OpenPGP');
