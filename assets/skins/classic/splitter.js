 ...
 * @constructor
 */
function chronomail_splitter(attrib)
{
  this.p1id = attrib.p1;
  this.p2id = attrib.p2;
  ...
  this.init = function()
  {
    ...
    if (this.horizontal) {
      ...
      this.layer = new chronomail_layer(this.id, {x: 0, y: top, height: 10,
        width: '100%', vis: 1, parent: this.p1.parentNode});
    }
    else {
      var left = this.p1pos.left + this.p1.offsetWidth;
      this.layer = new chronomail_layer(this.id, {x: left, y: 0, width: 10,
    ...
    var cookie = chronomail.get_cookie(this.id);
  ...
  this.set_cookie = function()
  {
    ...
    chronomail.set_cookie(this.id, this.pos, exp);
  };
