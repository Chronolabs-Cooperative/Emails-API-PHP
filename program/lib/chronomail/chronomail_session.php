 ...
 * @subpackage Core
 */
abstract class chronomail_session
{
    protected $config;
    protected $key;
    protected $ip;
    ...
    protected $cookiename   = 'chronomail_sessauth';
     ...
     *
     * @param object $config
     * @return Object chronomail_session
     */
    public static function factory($config)
    {
        ...
        $class = "chronomail_session_" . $storage;
        ...
        chronomail::raise_error(array('code' => 604, 'type' => 'session',
    ...
    public function start()
    {
        ...
        $this->ip      = chronomail_utils::remote_addr();
    ...
    public function write_close()
    {
        ...
        // write_close() is called on script shutdown, see chronomail::shutdown()
    ...
    public function create($data)
    {
        ...
        $key    = chronomail_utils::random_bytes($length);
    ...
    public function gc($maxlifetime)
    {
        ...
        // see chronomail::shutdown() and chronomail_session::write_close()
    ...
    public function kill()
    {
        ...
        $this->vars = null;
        $this->ip   = chronomail_utils::remote_addr(); // update IP (might have changed)
        $this->destroy(session_id());

        chronomail_utils::setcookie($this->cookiename, '-del-', time() - 60);
    }
    ...
    function set_secret($secret = null)
    {
        ...
        if (!$secret) {
            if (!empty($_SESSION['auth_secret'])) {
                ...
                $secret = chronomail_utils::random_bytes(strlen($this->key));
            }
        }
    ...
    function check_auth()
    {
        ...
        $result = $this->ip_check ? chronomail_utils::remote_addr() == $this->ip : true;

        if (!$result) {
            $this->log("IP check failed for " . $this->key . "; expected " . $this->ip . "; got " . chronomail_utils::remote_addr());
        }
    ...
    public function set_auth_cookie()
    {
        ...
        chronomail_utils::setcookie($this->cookiename, $this->cookie, 0);
    ...
    {
        if ($this->logging) {
            chronomail::write_log('session', $line);
        }
    }
}
