 ...
 */
class example_addressbook_backend extends chronomail_addressbook
{
    ...
    {
        return new chronomail_result_set(1, ($this->list_page-1) * $this->page_size);
    }
