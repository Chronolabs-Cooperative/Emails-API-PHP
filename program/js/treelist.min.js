...
d.on=!0),f=h):f=null):d.on&&(l(h).removeClass("droptarget"),d.on=!1);return f}function N(a){a||(a={});if("string"==$.type(a))return"destroy"==a&&(C=null),$("li:not(.virtual)",e).droppable(a),this;O=a;var b=$.extend({greedy:!0,tolerance:"pointer",hoverClass:"droptarget",addClasses:!1},a);b.activate=function(b,c){M();C=c;a.activate&&a.activate(b,c)};b.deactivate=function(b,c){ea();C=null;a.deactivate&&a.deactivate(b,c)};b.over=function(b,c){fa(chronomail_event.get_mouse_pos(b),!1);a.over&&a.over(b,c)};$("li:not(.virtual)",
...
function(a){var b=chronomail_event.get_keycode(a);chronomail_event.get_modifier(a);switch(b){case 9:break;case 13:return X(this.value,!0),chronomail_event.cancel(a);case 27:A();break;case 38:case 37:case 39:case 40:break;default:X(this.value,!1)}}).attr("autocomplete","off");L.parent().find("a.reset").off("click.treelist").on("click.treelist",function(a){A();return!1})}$(document.body).on("keydown",function(a){var b=a.target||{},d=chronomail_event.get_keycode(a);if(!D||"INPUT"==b.nodeName&&38!=d&&40!=d||"TEXTAREA"==
b.nodeName||"SELECT"==b.nodeName)return!0;switch(d){case 38:case 40:case 63232:case 63233:return b=g.keyboard?e.find(":focus").closest("li"):[],b.length&&aa(b,mod=38==d||63232==d?-1:1),chronomail_event.cancel(a);case 37:case 39:var c;b=e.find(":focus").closest("li");if(b.length&&(b=n(b),(c=k[b])&&c.children.length&&c.collapsed!=(37==d))){a=chronomail_event.get_modifier(a)==SHIFT_KEY;var f;(f=k[b])&&w(b,a,!f.collapsed)}return!1;case 9:g.keyboard&&g.tabexit&&(f=chronomail_event.get_modifier(a)==SHIFT_KEY?"first":
"last",f=e.find("li[role=treeitem]:has(a)")[f]().find("a:"+f),f.length&&(a=e.parent().get(0)||{scrollTop:0},d=a.scrollTop||a.scrollY,f.focus(),a.scrollTop=d))}return!0});g.parent_focus&&e.parent(":not(body)").click(function(a){if($(a.target).is("input"))return!0;!D&&h?$(V(h)).find(":focusable").first().focus():D||e.children("li").find(":focusable").first().focus()})}}chronomail_treelist_widget.prototype.addEventListener=chronomail_event_engine.prototype.addEventListener;
chronomail_treelist_widget.prototype.removeEventListener=chronomail_event_engine.prototype.removeEventListener;chronomail_treelist_widget.prototype.triggerEvent=chronomail_event_engine.prototype.triggerEvent;
