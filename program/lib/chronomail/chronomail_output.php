 ...
 * @subpackage View
 */
abstract class chronomail_output
{
    public $browser;
    ...
    public function __construct()
    {
        ...
        $this->browser = new chronomail_browser();
    }
    ...
    public function nocacheing_headers()
    {
        ...
        if ($this->browser->ie && chronomail_utils::https_check()) {
    ...
    public static function get_edit_field($col, $value, $attrib, $type = 'text')
    {
        ...
        if (isset($_POST[$fname])) {
            $postvalue = chronomail_utils::get_input_value($fname, chronomail_utils::INPUT_POST, true);
    ...
    public static function json_serialize($input, $pretty = false, $inline = true)
    {
        ...
        $input   = chronomail_charset::clean($input);
        ...
        // sometimes even using chronomail_charset::clean() the input contains invalid UTF-8 sequences
