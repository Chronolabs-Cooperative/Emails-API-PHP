...
class chronomail_sieve_forward extends chronomail_sieve_engine
{
    protected $error;
    ...
    private function forward_post()
    {
        ...
        $status = chronomail_utils::get_input_value('forward_status', chronomail_utils::INPUT_POST);
        $action = chronomail_utils::get_input_value('forward_action', chronomail_utils::INPUT_POST);
    ...
    public function forward_form($attrib)
    {
        ...
        $action_target = '<span id="action_target_span" class="input-group">'
            ...
            . ' value="' .($redirect ? chronomail::Q($this->forward['target'], 'strict', false) : '') . '"'
