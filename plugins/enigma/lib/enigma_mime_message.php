...
class enigma_mime_message extends Mail_mime
{
    ...
    public function getRecipients()
    {
        // get sender address
        $headers = $this->message->headers();
        $to      = chronomail_mime::decode_address_list($headers['To'], null, false, null, true);
        $cc      = chronomail_mime::decode_address_list($headers['Cc'], null, false, null, true);
        $bcc     = chronomail_mime::decode_address_list($headers['Bcc'], null, false, null, true);
