...
function(a){1==a.touches.length&&(b.touchmoved=!1,b.drag_row(chronomail_event.touchevent(a.touches[0]),this.uid),b.touch_start_time=(new Date).getTime())},!1),a.addEventListener("touchend",function(a){if(1==a.changedTouches.length){var c=(new Date).getTime()-b.touch_start_time;!b.touchmoved&&c<=b.touch_event_time&&!b.click_row(chronomail_event.touchevent(a.changedTouches[0]),this.uid)&&a.preventDefault()}},!1),a.addEventListener("touchmove",function(a){1==a.changedTouches.length&&(b.touchmoved=!0,b.drag_active&&
...
e.type="checkbox";e.tabIndex=-1;e.onchange=function(d){c.select_row(a.uid,b||CONTROL_KEY,!0);d.stopPropagation();b=null};e.onmousedown=function(a){b=chronomail_event.get_modifier(a)};d.className="selection";d.onclick=function(a){$(a.target).is("input")||(b=chronomail_event.get_modifier(a),$(e).prop("checked",!e.checked).change());a.stopPropagation()};d.appendChild(e);a.insertBefore(d,a.firstChild)},enable_checkbox_selection:function(){this.checkbox_selection=!0;var a,b,c=this.row_tagname().toUpperCase(),d=
this.tbody.childNodes;var e=0;for(a=d.length;e<a;e++)if(d[e].nodeName==c&&(b=d[e].firstChild)){if("selection"==b.className)break;this.insert_checkbox(d[e])}},focus:function(a){this.focused||(this.focused=!0,a&&chronomail_event.cancel(a),a=null,this.last_selected&&this.rows[this.last_selected]&&(a=$(this.rows[this.last_selected].obj).find(this.col_tagname()).eq(this.subject_column()).attr("tabindex","0")),a&&a.length?this.focus_noscroll(a):($("iframe,:focus:not(body)").blur(),window.focus()),$(this.list).addClass("focus").removeAttr("tabindex"),
...
"removeClass";if(this.fixed_header)$(this.row_tagname()+" "+this.col_tagname()+"."+a,this.fixed_header)[b]("hidden");$(this.row_tagname()+" "+this.col_tagname()+"."+a,this.list)[b]("hidden")},drag_column:function(a,b){if(1<this.colcount)for(this.drag_start=!0,this.drag_mouse_start=chronomail_event.get_mouse_pos(a),chronomail_event.add_listener({event:"mousemove",object:this,method:"column_drag_mouse_move"}),chronomail_event.add_listener({event:"mouseup",object:this,method:"column_drag_mouse_up"}),this.add_dragfix(),
a=0;a<this.thead.rows[0].cells.length;a++)if(b==this.thead.rows[0].cells[a]){this.selected_column=a;break}return!1},drag_row:function(a,b){if(!this.is_event_target(a)||2==chronomail_event.get_button(a))return!0;this.in_selection_before=a&&a.istouch||this.in_selection(b)?b:!1;if(!this.in_selection_before){var c=chronomail_event.get_modifier(a);this.select_row(b,c,!0)}this.draggable&&this.selection.length&&this.in_selection(b)&&(this.drag_start=!0,this.drag_mouse_start=chronomail_event.get_mouse_pos(a),chronomail_event.add_listener({event:"mousemove",
object:this,method:"drag_mouse_move"}),chronomail_event.add_listener({event:"mouseup",object:this,method:"drag_mouse_up"}),bw.touch&&(chronomail_event.add_listener({event:"touchmove",object:this,method:"drag_mouse_move"}),chronomail_event.add_listener({event:"touchend",object:this,method:"drag_mouse_up"})),this.add_dragfix(),this.focus());return!1},click_row:function(a,b){if(!b||!this.rows[b])return!1;if(!this.is_event_target(a))return!0;var c=(new Date).getTime(),d=c-this.rows[b].clicked<this.dblclick_time;this.drag_active||
d||this.in_selection_before!=b||this.select_row(b,chronomail_event.get_modifier(a),!0);this.in_selection_before=this.drag_start=!1;this.rowcount&&d&&this.in_selection(b)?(this.triggerEvent("dblclick"),c=0):this.triggerEvent("click");this.drag_active||(this.del_dragfix(),chronomail_event.cancel(a));this.rows[b].clicked=c;this.focus();return!1},is_event_target:function(a){a=chronomail_event.get_target(a);var b=a.tagName.toLowerCase();return!(a&&("input"==b||"img"==b||"a"!=b&&a.onclick||$(a).data("action-link")))},
find_root:function(a){var b=this.rows[a];return b&&b.parent_uid?this.find_root(b.parent_uid):a},expand_row:function(a,b){b=this.rows[b];chronomail_event.get_target(a);a=chronomail_event.get_modifier(a);a=(b.expanded?"collapse":"expand")+(a==CONTROL_KEY||this.multiexpand?"_all":"");b.clicked=0;this[a](b)},collapse:function(a){var b=a.depth,c=a?a.obj.nextSibling:null;a.expanded=!1;this.update_expando(a.id);for(this.triggerEvent("expandcollapse",{uid:a.uid,expanded:a.expanded,obj:a.obj});c;){if(1==c.nodeType){if((a=
...
$(a.target).is("input,textarea,select"))return!0;var b=chronomail_event.get_keycode(a),c=chronomail_event.get_modifier(a);switch(b){case 37:case 39:case 40:case 38:case 63233:case 63232:return chronomail_event.cancel(a),this.use_arrow_key(b,c);case 32:return chronomail_event.cancel(a),this.select_row(this.last_selected,c,!0);case 36:return this.select_first(c),chronomail_event.cancel(a);case 35:return this.select_last(c),chronomail_event.cancel(a);case 65:if(c==CONTROL_KEY&&this.multiselect)return this.select_first(),this.select_last(SHIFT_KEY),
chronomail_event.cancel(a);break;case 27:return this.drag_active?this.drag_mouse_up(a):this.col_drag_active?(this.selected_column=null,this.column_drag_mouse_up(a)):chronomail_event.cancel(a);case 9:this.blur();break;case 13:this.selection.length||this.select_row(this.last_selected,c,!1);default:if(this.key_pressed=b,this.modkey=c,this.triggerEvent("keypress"),this.modkey=0,this.key_pressed==this.BACKSPACE_KEY)return chronomail_event.cancel(a)}return!0},use_arrow_key:function(a,b){var c=this.rows[this.last_selected];
...
a)if(b=$(b).clone(),$(b).find(".skip-on-drag").remove(),a=b.text())return a=$.trim(a),a=50<a.length?a.substring(0,50)+"...":a,d.draglayer.append($("<div>").text(a)),!1})});this.draglayer.show();this.drag_active=!0;this.triggerEvent("dragstart")}this.drag_active&&this.draglayer&&(b=chronomail_event.get_mouse_pos(a),this.draglayer.css({left:b.x+20+"px",top:b.y-5+(bw.ie?document.documentElement.scrollTop:0)+"px"}),this.triggerEvent("dragmove",a?a:window.event));return this.drag_start=!1},drag_mouse_up:function(a){document.onmousemove=
null;if("touchend"==a.type&&1!=a.changedTouches.length)return chronomail_event.cancel(a);this.draglayer&&this.draglayer.is(":visible")&&(this.drag_start_pos?this.draglayer.animate(this.drag_start_pos,300,"swing").hide(20):this.draglayer.hide());this.drag_active&&this.focus();this.drag_active=!1;chronomail_event.remove_listener({event:"mousemove",object:this,method:"drag_mouse_move"});chronomail_event.remove_listener({event:"mouseup",object:this,method:"drag_mouse_up"});bw.touch&&(chronomail_event.remove_listener({event:"touchmove",
object:this,method:"drag_mouse_move"}),chronomail_event.remove_listener({event:"touchend",object:this,method:"drag_mouse_up"}));this.del_dragfix();this.triggerEvent("dragend",a);return chronomail_event.cancel(a)},column_drag_mouse_move:function(a){if(this.drag_start){var b=chronomail_event.get_mouse_pos(a);if(!this.drag_mouse_start||3>Math.abs(b.x-this.drag_mouse_start.x)&&3>Math.abs(b.y-this.drag_mouse_start.y))return!1;if(!this.col_draglayer){b=$(this.list).offset();var c=this.thead.rows[0].cells;b.top+=this.list.scrollTop+
...
c.length;b++)this.cols[b]=c[b].offsetWidth,null!==this.column_fixed&&b<=this.column_fixed&&(this.list_min_pos+=this.cols[b])}this.col_draglayer.show();this.col_drag_active=!0;this.triggerEvent("column_dragstart")}if(this.col_drag_active&&this.col_draglayer){c=0;var d=chronomail_event.get_mouse_pos(a);for(b=0;b<this.cols.length;b++)if(d.x>=this.cols[b]/2+this.list_pos+c)c+=this.cols[b];else break;0==b&&this.list_min_pos>d.x?c=this.list_min_pos-this.list_pos:this.list.rowcount||b!=this.cols.length||(c-=
2);$("#rcmcolumnindicator").css({width:c+"px"});this.triggerEvent("column_dragmove",a?a:window.event)}return this.drag_start=!1},column_drag_mouse_up:function(a){document.onmousemove=null;this.col_draglayer&&(this.col_draglayer.remove(),this.col_draglayer=null);chronomail_event.remove_listener({event:"mousemove",object:this,method:"column_drag_mouse_move"});chronomail_event.remove_listener({event:"mouseup",object:this,method:"column_drag_mouse_up"});this.del_dragfix();if(this.col_drag_active&&(this.col_drag_active=
!1,this.focus(),this.triggerEvent("column_dragend",a),null!==this.selected_column&&this.cols&&this.cols.length)){var b,c=0,d=chronomail_event.get_mouse_pos(a);for(b=0;b<this.cols.length;b++)if(d.x>=this.cols[b]/2+this.list_pos+c)c+=this.cols[b];else break;b!=this.selected_column&&b!=this.selected_column+1&&this.column_replace(this.selected_column,b)}return chronomail_event.cancel(a)},row_children:function(a){if(!this.rows[a]||!this.rows[a].has_children)return[];var b=[],c=this.rows[a].depth;for(a=this.rows[a].obj.nextSibling;a;){if(1==
...
this.subject_col--;this.fixed_header&&this.init_header();this.triggerEvent("column_replace")}},subject_column:function(){return this.subject_col+(this.checkbox_selection?1:0)}};chronomail_list_widget.prototype.addEventListener=chronomail_event_engine.prototype.addEventListener;chronomail_list_widget.prototype.removeEventListener=chronomail_event_engine.prototype.removeEventListener;chronomail_list_widget.prototype.triggerEvent=chronomail_event_engine.prototype.triggerEvent;chronomail_list_widget._instances=[];
