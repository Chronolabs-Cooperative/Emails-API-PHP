...
class chronomail_expect_password
{
    public function save($currpass, $newpass, $username)
    {
        $chronomail   = chronomail::get_instance();
        $bin      = $chronomail->config->get('password_expect_bin');
        $script   = $chronomail->config->get('password_expect_script');
        $params   = $chronomail->config->get('password_expect_params');
