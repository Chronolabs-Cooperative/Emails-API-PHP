 ...
 * @subpackage LDAP
 */
class chronomail_ldap_generic extends Net_LDAP3
{
    /** private properties */
    ...
    public function connect($host = null)
    {
        ...
        // also parse_host() here is very chronomail specific
        $host = chronomail_utils::parse_host($host, $this->config['mail_domain']);
    ...
    public function log($level, $msg)
    {
        ...
        case LOG_ALERT:
        case LOG_CRIT:
            chronomail::raise_error($msg, true, true);
            break;

        case LOG_ERR:
        case LOG_WARNING:
            $this->error = $msg;
            chronomail::raise_error($msg, true, false);
            break;
        }
    }
    ...
    public static function fulltext_search_filter($value, $attributes, $mode = 1)
    {
        ...
        $words = $mode == 0 ? chronomail_utils::tokenize_string($value, 1) : array($value);
...
// for backward compat.
class chronomail_ldap_result extends Net_LDAP3_Result {}
