 ...
 * @subpackage Utils
 */
class chronomail_string_replacer extends chronomail_string_replacer
{
    /**
     ...
     * @see chronomail_string_replacer::mailto_callback()
     */
    public function mailto_callback($matches)
    {
        ...
        $i = $this->add(html::a(array(
            'href'    => 'mailto:' . $href,
            'onclick' => "return ".chronomail_output::JS_OBJECT_NAME.".command('compose','".chronomail::JQ($href)."',this)",
            ),
            chronomail::Q($href)) . $suffix);
