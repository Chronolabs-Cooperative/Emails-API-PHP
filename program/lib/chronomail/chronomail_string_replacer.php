 ...
 * @subpackage Utils
 */
class chronomail_string_replacer
{
    ...
    public function link_callback($matches)
    {
        ...
        if ($url) {
            ...
            $i = $this->add(html::a($attrib, chronomail::Q($url)) . $suffix);
    ...
    public function linkref_callback($matches)
    {
        ...
        if ($url = $this->linkrefs[$matches[1]]) {
            $attrib = (array)$this->options['link_attribs'];
            $attrib['href'] = $url;
            $i = $this->add(html::a($attrib, chronomail::Q($matches[1])));
        }
    ...
    public function mailto_callback($matches)
    {
        ...
        $i = $this->add(html::a('mailto:' . $href, chronomail::Q($href)) . $suffix);
