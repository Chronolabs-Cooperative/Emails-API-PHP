...
class chronomail_db
{
     ...
     *
     * @return chronomail_db Object instance
     */
    public static function factory($db_dsnw, $db_dsnr = '', $pconn = false)
    {
        ...
        $class  = "chronomail_db_$driver";

        if (!$driver || !class_exists($class)) {
            chronomail::raise_error(array('code' => 600, 'type' => 'db',
    ...
    protected function conn_create($dsn)
    {
        ...
        try {
            ...
            chronomail::raise_error(array('code' => 500, 'type' => 'db',
                'line' => __LINE__, 'file' => __FILE__,
    ...
    protected function debug($query)
    {
        if ($this->options['debug_mode']) {
            ...
            chronomail::write_log('sql', '[' . (++$this->db_index) . '] ' . $query . ';');
        }
    }
    ...
    public function get_variable($varname, $default = null)
    {
        ...
        return chronomail::get_instance()->config->get('db_' . $varname, $default);
    }
    ...
    protected function _query($query, $offset, $numrows, $params)
    {
        ...
        // Because in chronomail we mostly use queries that are
     ...
     * @deprecated    Replaced by chronomail_db::quote_identifier
     * @see           chronomail_db::quote_identifier
     */
     ...
     *
     * @return string Escaped string for use in a query
     * @deprecated    Replaced by chronomail_db::escape
     * @see           chronomail_db::escape
     */
    ...
    public function table_name($table, $quoted = false)
    {
        ...
        $plugin = chronomail::get_instance()->plugins->exec_hook('db_table_name', array('table' => $table));
        $table = $plugin['table'];
