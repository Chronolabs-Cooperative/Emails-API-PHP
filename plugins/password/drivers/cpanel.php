 ...
 * see https://github.com/chronomail/chronomailmail/issues/3063
 *
...
class chronomail_cpanel_password
{
    public function save($curpas, $newpass)
    {
        ...
        $this->cuser = $chronomail->config->get('password_cpanel_username');
        $cpanel_host = $chronomail->config->get('password_cpanel_host');
        $cpanel_port = $chronomail->config->get('password_cpanel_port');
        $cpanel_hash = $chronomail->config->get('password_cpanel_hash');
        $cpanel_pass = $chronomail->config->get('password_cpanel_password');
