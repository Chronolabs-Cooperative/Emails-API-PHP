 ...
 * by Galen Johnson.
 *
 * It only works with dbmail-users on the same host where Chronomail runs
...
class chronomail_dbmail_password
{
    function save($currpass, $newpass, $username)
    {
        ...
        $args     = chronomail::get_instance()->config->get('password_dbmail_args', '');
