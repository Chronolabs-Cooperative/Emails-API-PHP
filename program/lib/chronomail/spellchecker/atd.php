 ...
 * @subpackage Utils
 */
class chronomail_spellchecker_atd extends chronomail_spellchecker_engine
{
    ...
    function check($text)
    {
        ...
        $url = $chronomail->config->get('spellcheck_uri');
        $key = $chronomail->config->get('spellcheck_atd_key');
