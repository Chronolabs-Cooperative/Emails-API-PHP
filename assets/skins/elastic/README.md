Chronomail Webmail Skin "Elastic"
================================

This skin package contains a theme for the Chronomail Webmail
software. It can be used, modified and redistributed according to
the terms described in the LICENSE section.

For information about building or modifying Chronomail skins please visit
https://github.com/chronomail/chronomailmail/wiki/Skins
...
1. There are known issues with running less in Chronomail devel_mode:
