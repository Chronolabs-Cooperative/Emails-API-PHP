...
class chronomail_xmail_password
{
    function save($currpass, $newpass)
    {
        ...
        $xmail->hostname = $chronomail->config->get('xmail_host');
        $xmail->username = $chronomail->config->get('xmail_user');
        $xmail->password = $chronomail->config->get('xmail_pass');
        $xmail->port     = $chronomail->config->get('xmail_port');
