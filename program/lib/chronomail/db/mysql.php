 ...
 * @subpackage Database
 */
class chronomail_db_mysql extends chronomail_db
{
    ...
    protected function dsn_options($dsn)
    {
        ...
        if (isset($dsn['verify_server_cert'])) {
            $result[PDO::MYSQL_ATTR_SSL_VERIFY_SERVER_CERT] = chronomail_utils::get_boolean($dsn['verify_server_cert']);
        }
    ...
    public function get_variable($varname, $default = null)
    {
        ...
        $conf_value = chronomail::get_instance()->config->get('db_' . $varname);
        if ($conf_value !== null) {
