...
class chronomail_plugin_api
{
     ...
     *
     * @return chronomail_plugin_api The one and only instance if this class
     */
    static function get_instance()
    {
        if (!self::$instance) {
            self::$instance = new chronomail_plugin_api();
        }
     ...
     *
     * This has to be done after chronomail::load_gui() or chronomail::json_init()
     * was called because plugins need to have access to chronomail->output
     *
     * @param object chronomail Instance of the chronomail base class
    ...
    public function load_plugin($plugin_name, $force = false, $require = true)
    {
        ...
        if (!$this->plugins[$plugin_name]) {
            ...
            if (!is_readable($fn)) {
                if ($require) {
                    chronomail::raise_error(array('code' => 520, 'type' => 'php',
                        'file' => __FILE__, 'line' => __LINE__,
            ...
            // check inheritance...
            if (is_subclass_of($plugin, 'chronomail_plugin')) {
    ...
    public function register_hook($hook, $callback)
    {
        if (is_callable($callback)) {
            if (isset($this->deprecated_hooks[$hook])) {
                chronomail::raise_error(array('code' => 522, 'type' => 'php',
                    'file' => __FILE__, 'line' => __LINE__,
            ...
            chronomail::raise_error(array('code' => 521, 'type' => 'php',
                'file' => __FILE__, 'line' => __LINE__,
    ...
    public function register_action($action, $owner, $callback, $task = null)
    {
        ...
        if (!isset($this->actionmap[$action]) || $this->actionmap[$action] == $owner) {
            ...
            chronomail::raise_error(array('code' => 523, 'type' => 'php',
                'file' => __FILE__, 'line' => __LINE__,
    ...
    public function exec_action($action)
    {
        ...
        else if (chronomail::get_instance()->action != 'refresh') {
            chronomail::raise_error(array('code' => 524, 'type' => 'php',
                'file' => __FILE__, 'line' => __LINE__,
    ...
    public function register_handler($name, $owner, $callback)
    {
        ...
        if (is_object($this->output)
            ...
            chronomail::raise_error(array('code' => 525, 'type' => 'php',
                'file' => __FILE__, 'line' => __LINE__,
    ...
    public function register_task($task, $owner)
    {
        ...
        if ($task != asciiwords($task, true)) {
            chronomail::raise_error(array('code' => 526, 'type' => 'php',
                'file' => __FILE__, 'line' => __LINE__,
                'message' => "Invalid task name: $task."
                    ." Only characters [a-z0-9_.-] are allowed"), true, false);
        }
        else if (in_array($task, chronomail::$main_tasks)) {
            chronomail::raise_error(array('code' => 526, 'type' => 'php',
                'file' => __FILE__, 'line' => __LINE__,
    ...
    public function include_stylesheet($fn)
    {
        if (is_object($this->output) && $this->output->type == 'html') {
            if ($fn[0] != '/' && !preg_match('|^https?://|i', $fn)) {
                ...
                $devel_mode = $chronomail->config->get('devel_mode');
                $assets_dir = $chronomail->config->get('assets_dir');
     ...
     *
     * @return chronomail_plugin Plugin instance
     */
