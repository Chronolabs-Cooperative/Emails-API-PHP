 ...
 * @subpackage View
 */
class chronomail_output_json extends chronomail_output
{
    ...
    protected function remote_response($add = '')
    {
        ...
        $response['action'] = $chronomail->action;

        if ($unlock = chronomail_utils::get_input_value('_unlock', chronomail_utils::INPUT_GPC)) {
