 ...
 */
class enigma extends chronomail_plugin
{
...
*/
    ...
    function preferences_save($p)
    {
        if ($p['section'] == 'enigma') {
            $p['prefs'] = array(
                'enigma_signatures'    => (bool) chronomail_utils::get_input_value('_enigma_signatures', chronomail_utils::INPUT_POST),
                'enigma_decryption'    => (bool) chronomail_utils::get_input_value('_enigma_decryption', chronomail_utils::INPUT_POST),
                'enigma_encryption'    => (bool) chronomail_utils::get_input_value('_enigma_encryption', chronomail_utils::INPUT_POST),
                'enigma_sign_all'      => (bool) chronomail_utils::get_input_value('_enigma_sign_all', chronomail_utils::INPUT_POST),
                'enigma_encrypt_all'   => (bool) chronomail_utils::get_input_value('_enigma_encrypt_all', chronomail_utils::INPUT_POST),
                'enigma_attach_pubkey' => (bool) chronomail_utils::get_input_value('_enigma_attach_pubkey', chronomail_utils::INPUT_POST),
                'enigma_password_time' => intval(chronomail_utils::get_input_value('_enigma_password_time', chronomail_utils::INPUT_POST)),
            );
        }
