...
define('API_MINBITS_PGPKEYS_LABEL', 'Minimum Bits to randomly select from generating PGP Keys');
define('API_MINBITS_PGPKEYS_HELP', 'Minimum Bits for PGP Keys');
define('API_MAXBITS_PGPKEYS_LABEL', 'Maximum Bits to randomly select from generating PGP Keys');
define('API_MAXBITS_PGPKEYS_HELP', 'Maximum Bits for PGP Keys');
