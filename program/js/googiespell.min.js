...
this.edit_layer_dbl_click=!0;this.custom_no_spelling_error=this.custom_ajax_error=null;this.extra_menu_items=[];this.custom_spellcheck_starter=null;this.main_controller=!0;this.has_dictionary=v;this.all_errors_fixed_observer=this.show_menu_observer=this.spelling_state_observer=this.lang_state_observer=null;this.use_focus=!1;this.focus_link_b=this.focus_link_t=null;this.cnt_errors_fixed=this.cnt_errors=0;$(document).click(function(a){"1"!=$(a.target).attr("googie_action_btn")&&q.isErrorWindowShown()&&
...
$(d).height(f).width(e).css("text-align","right");this.spell_container=d}this.checkSpellingState()}else this.report_ta_not_found&&chronomail.alert_dialog("Text area not found")};this.setSpellContainer=function(a){this.spell_container="string"===typeof a?document.getElementById(a):a};this.setLanguages=function(a){this.lang_to_word=a;this.langlist_codes=this.array_keys(a)};this.setCurrentLanguage=function(a){GOOGIE_CUR_LANG=a;var b=new Date;b.setTime(b.getTime()+31536E6);chronomail.set_cookie("language",a,
...
if(b){var f=document.createElement("span");$(f).addClass(b).html(a)}else f=document.createTextNode(a);$(e).click(c).mouseover(this.item_onmouseover).mouseout(this.item_onmouseout);e.appendChild(f);d.appendChild(e);return d};this.removeIndicator=function(a){window.chronomail&&chronomail.set_busy(!1,null,this.rc_msg_id)};this.appendIndicator=function(a){window.chronomail&&(this.rc_msg_id=chronomail.set_busy(!0,"checking"))};this.createFocusLink=function(a){var b=document.createElement("a");$(b).attr({href:"javascript:;",
