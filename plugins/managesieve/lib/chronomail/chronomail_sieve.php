...
class chronomail_sieve
{
    ...
    public $script;                 // chronomail_sieve_script object
    ...
    public function load($name)
    {
        ...
        // try to parse to Chronomail format
    ...
    /**
     * Creates chronomail_sieve_script object from text script
     */
    private function _parse($txt)
    {
        // parse
        $script = new chronomail_sieve_script($txt, $this->exts);

        // fix/convert to Chronomail format
    ...
    {
        chronomail::write_log('sieve', preg_replace('/\r\n$/', '', $message));
    }
}
