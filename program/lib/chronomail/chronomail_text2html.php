...
class chronomail_text2html
{
    ...
    protected $config = array(
        ...
        'replacer' => 'chronomail_string_replacer',
    ...
    protected function _converter($text)
    {
        ...
        if ($this->config['flowed']) {
            ...
            $text        = chronomail_mime::unfold_flowed($text, chr($flowed_char), $delsp);
        }
        ...
        $sig_max_lines = chronomail::get_instance()->config->get('sig_max_lines', 15);
