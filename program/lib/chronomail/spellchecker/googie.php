 ...
 * @subpackage Utils
 */
class chronomail_spellchecker_googie extends chronomail_spellchecker_engine
{
    const GOOGIE_HOST = 'ssl://spell.chronomail.net';
     ...
     *
     * @see chronomail_spellchecker_engine::languages()
     */
    function languages()
    {
     ...
     *
     * @see chronomail_spellchecker_engine::check()
     */
    function check($text)
    {
        $this->content = $text;
        ...
        $url = chronomail::get_instance()->config->get('spellcheck_uri');
        ...
        if ($fp = fsockopen($host, $port, $errno, $errstr, 30)) {
            ...
            $out .= "User-Agent: chronomail Webmail/" . RCUBE_VERSION . " (Googiespell Wrapper)\r\n";
     ...
     *
     * @see chronomail_spellchecker_engine::get_words()
     */
     ...
     *
     * @see chronomail_spellchecker_engine::get_suggestions()
     */
