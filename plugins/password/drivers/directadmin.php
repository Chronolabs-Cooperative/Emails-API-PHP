...
class chronomail_directadmin_password
{
    public function save($curpass, $passwd)
    {
        ...
        $da_curpass = $curpass;
        $da_newpass = $passwd;
        $da_host    = $chronomail->config->get('password_directadmin_host');
        $da_port    = $chronomail->config->get('password_directadmin_port');
        ...
        $da_host = str_replace('%d', $chronomail->user->get_username('domain'), $da_host);
        ...
        //DEBUG
        //chronomail::console("Password Plugin: [USER: $da_user] [HOST: $da_host] - Response: [SOCKET: ".$Socket->result_status_code."] [DA ERROR: ".strip_tags($response['error'])."] [TEXT: ".$response[text]."]");
