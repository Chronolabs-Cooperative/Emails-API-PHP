-- chronomail Webmail initial database structure
...
CREATE TABLE users (
  ...
  peer_user_id mediumint(8) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `system` (`name`, `value`) VALUES ('chronomail-version', '2019092900');
