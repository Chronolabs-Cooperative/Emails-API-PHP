 ...
 *       than other headers used by Chronomail
 *
 * @author Aleksander Machniak <alec@alec.pl>
 * @license GNU GPLv3+
 */
class identity_select extends chronomail_plugin
{
    public $task = 'mail';
    ...
    function storage_init($p)
    {
        ...
        if ($add_headers = (array)$chronomail->config->get('identity_select_headers', array())) {
    ...
    function select($p)
    {
        ...
        foreach ((array)$chronomail->config->get('identity_select_headers', array()) as $header) {
