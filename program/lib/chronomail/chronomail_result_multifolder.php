...
/**
 * Class holding a set of chronomail_result_index instances that together form a
 * result set of a multi-folder search
 *
 * @package    Framework
 * @subpackage Storage
 */
class chronomail_result_multifolder
{
    public $multi      = true;
    public $sets       = array();
    ...
    /**
     * Returns number of elements in the result.
     * Alias for count() for compatibility with chronomail_result_thread
     *
     * @return int Number of elements
     */
     ...
     *
     * @return false|object chronomail_result_* instance of false if none found
     */
    ...
    public function __wakeup()
    {
        ...
        foreach ($this->folders as $folder) {
            ...
            $set = new chronomail_result_index($folder, $data_str, strtoupper($this->order));
