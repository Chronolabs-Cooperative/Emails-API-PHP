 ...
 * @subpackage Core
 */
class chronomail_session_redis extends chronomail_session {
     ...
     * Object constructor
     *
     * @param chronomail_config $config Configuration
     */
    public function __construct($config)
    {
        parent::__construct($config);

        $this->redis = chronomail::get_instance()->get_redis();
    ...
    public function destroy($key)
    {
        if ($key) {
            try {
                ...
                chronomail::raise_error($e, true, true);
            }
    ...
    protected function debug($type, $key, $data = null, $result = null)
    {
        ...
        chronomail::debug('redis', $line, $result);
    }
}
